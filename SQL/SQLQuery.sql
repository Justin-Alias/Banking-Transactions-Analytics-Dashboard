...
-------------------------------------------------------------
-- Begin fixing all the issues with the dataset --
-- Fix number 1 (there isn't a standardizied format for the date within the accounts, customers, and transaction table)
UPDATE Accounts
SET OpenDate = 
    CASE
...
-- Performing a join across the three different tables
SELECT
    t.TransactionID,
